        ...
        <section>
            <div class="container-lg mt-3">
                <div class="row mb-3">
                    ...
                    <a href={{ route("tambahOrganisasi") }} class="btn btn-dark ms-3 fit-content">Tambah Kegiatan</a>
                </div>
                ...
                <div class="row align-items-stretch mb-3">
                    <div class="col-md-4 overflow-scroll boxSatu">
                        {{-- Open Looping --}}
                    ...
                    <div class="col-md-8">
                        <div class="boxx border border-dark rounded-4 p-3 boxDua">
                            ...
                            <div class="boxx-actions d-flex mb-3">
                                <a href="" class="btn btn-outline-dark me-3">Edit Kegiatan</a>
                                <a href="" class="btn btn-danger">Hapus Kegiatan</a>
                            </div>
                            <div class="boxx-body">
